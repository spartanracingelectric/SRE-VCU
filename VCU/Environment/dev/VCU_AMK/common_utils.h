 ...
 * the original codebase. This reduces code duplication and improves maintainability.
 ****************************************************************************/
...
/**
 * Clamp value to range (signed)
 * @param value Value to clamp
 * @param minValue Minimum allowed value
 * @param maxValue Maximum allowed value
 * @return Clamped value
 */
sbyte2 CommonUtils_clampToRangeSigned(sbyte2 value, sbyte2 minValue, sbyte2 maxValue);
