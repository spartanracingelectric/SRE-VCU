/*****************************************************************************
 * vcu_globals.h - Centralized Global Variables and Constants
 * Optimized Version
 ******************************************************************************
 * This file centralizes all global variables and constants that were
 * scattered throughout the original codebase. This improves maintainability
...
#define VCU_TORQUE_LIMIT_POS_01NM      ((sbyte2)(VCU_MAX_TORQUE_NM * VCU_TORQUE_LIMIT_SCALE_FACTOR))
...
#define VCU_BMS_CONFIGUATION_INFORMATION 0x0FC
