...
void vcu_initializeADC(bool benchMode)
{
    ...
    Sensor_TPS1.ioErr_powerSet = Sensor_BPS1.ioErr_powerSet = IO_POWER_Set(IO_ADC_SENSOR_SUPPLY_2, IO_POWER_ON);  // Pin 147
    ...
    if (benchMode == TRUE)
    {
        ...
        Sensor_TPS0.ioErr_signalInit = IO_ADC_ChannelInit(IO_ADC_5V_07, IO_ADC_RESISTIVE, 0, 0, 0, NULL);
    ...
    else //Not bench mode
    {
        ...
        //Redo BPS ratiometric
        Sensor_TPS0.ioErr_signalInit = IO_ADC_ChannelInit(IO_ADC_5V_07, IO_ADC_RATIOMETRIC, 0, 0, IO_ADC_SENSOR_SUPPLY_0, NULL);
        Sensor_TPS1.ioErr_signalInit = IO_ADC_ChannelInit(IO_ADC_5V_06, IO_ADC_RATIOMETRIC, 0, 0, IO_ADC_SENSOR_SUPPLY_2, NULL);
    ...
    Sensor_HVILTerminationSense.ioErr_signalInit = IO_DI_Init(IO_DI_06, IO_DI_PU_10K); //HVIL Term sense, high = HV present
}
